...
export default async function LeaderboardPage({ searchParams }: { searchParams: SearchParams }) {
  ...
  let query = supabase
    ...
    .select('result_id, total_seconds, swim_seconds, bike_seconds, run_seconds, display_name, gender, age_group, nationality, source_credibility, race_name, edition_year, distance_category, race_id, race_slug')
                ...
                <tr key={e.result_id}
                  ...
                  <td className="px-4 py-3 text-ink-3">
                    ...
                    <span className="ml-1 text-xs text-ink-4">
                      {DISTANCE_LABEL[e.distance_category]}
                    </span>
                  </td>
